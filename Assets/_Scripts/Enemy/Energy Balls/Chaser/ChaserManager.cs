...
public class ChaserManager : EnemyManager
{
    protected override void SpawnEnemy()
    {
        ...
        Vector3 localSP = new Vector3(sp.transform.position.x + Random.Range(-20f, 20f), sp.transform.position.y, sp.transform.position.z + Random.Range(-20f, 20f));

        Chaser chaser = PhotonNetwork.Instantiate(chaserPath, localSP, sp.transform.rotation).GetComponent<Chaser>();
