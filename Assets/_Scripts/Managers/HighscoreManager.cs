...
public class HighscoreManager : MonoBehaviour
{
    ...
    public void ShowHighscores(string level, GameObject entryTemplate, GameObject parent)
    {
        // Get highscores (and sorts them beforehand)
        List<HighscoreEntry> highscoreEntries = Instance.GetHighscoresByStage(level);
