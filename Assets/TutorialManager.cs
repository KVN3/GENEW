...
public class TutorialManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // 6 Your ship is equipped with a forcefield. To activate yours, hold down the "SPACE" key. Keep an eye on the charge bar just below the speed meter. You would not want to run out of charges in the middle of a cloud of toxic gas.
    ...
    private void RemoveInvisibleWall(int index)
    {
